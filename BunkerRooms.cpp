...
reloop:
    ...
    retry:
        ...
        if (RNG (2)) {
            /* a wide room */
            y = RNG (MSY);
            if (-1 == macrosq[x][y] && x < MSX - 1 && -1 == macrosq[x+1][y]) {
                if (RNG(3) && y > 0 && 
                    (-1 != macrosq[x][y-1] || -1 != macrosq[x+1][y-1])) 
                {
                    goto retry;
                }
                if (RNG(2) && y < MSY - 1 && 
                ...
                rooms[i].sx = x;
                rooms[i].sy = y;
                if (RNG(4) && x < MSX - 2 && -1 == macrosq[x+2][y]) {
                    macrosq[x+2][y] = i;
                    rooms[i].ex = x+2;
                } else {
                    rooms[i].ex = x+1;
            ...
            /* a tall room */
            y = RNG (MSY-1);
            if (-1 == macrosq[x][y] && -1 == macrosq[x][y+1]) {
                macrosq[x][y] = i;
                macrosq[x][y+1] = i;
                rooms[i].sx = x;
                rooms[i].sy = y;
                ...
                rooms[i].ex = x;                
                if (RNG (4) && x < MSX - 1 && 
                    -1 == macrosq[x+1][y] && -1 == macrosq[x+1][y+1]) 
                {
                    macrosq[x+1][y] = i;
                    macrosq[x+1][y+1] = i;
                    rooms[i].ex = x+1;
...
*/
                        ...
                        if (rooms[room].rsx + 1 > rooms[i].rex - 1 ||
